...
namespace NewLean.Touch
{
    ...
    public class NewLeanFinger
    {
        ...
        public bool IsActive
        {
            get
            {
                return NewLeanTouch.Fingers.Contains(this);
            }
        }
        ...
        public bool IsOverGui
        {
            get
            {
                return NewLeanTouch.PointOverGui(ScreenPosition);
            }
        }
        ...
        public Vector2 LastSnapshotScaledDelta
        {
            get
            {
                return LastSnapshotScreenDelta * NewLeanTouch.ScalingFactor;
            }
        }
        ...
        public Vector2 ScaledDelta
        {
            get
            {
                return ScreenDelta * NewLeanTouch.ScalingFactor;
            }
        }
        ...
        public Vector2 SwipeScaledDelta
        {
            get
            {
                return SwipeScreenDelta * NewLeanTouch.ScalingFactor;
            }
        }
        ...
        {
            return GetSnapshotScreenDelta(deltaTime) * NewLeanTouch.ScalingFactor;
        }
        ...
        {
            return GetScreenDistance(point) * NewLeanTouch.ScalingFactor;
        }
        ...
        {
            return GetLastScreenDistance(point) * NewLeanTouch.ScalingFactor;
        }
        ...
        public void ClearSnapshots(int count = -1)
        {
            ...
            if (count > 0 && count <= Snapshots.Count)
            {
                ...
                {
                    NewLeanSnapshot.InactiveSnapshots.Add(Snapshots[i]);
                }
            ...
            {
                NewLeanSnapshot.InactiveSnapshots.AddRange(Snapshots);
        ...
        public GameObject FlagObjectTouched(Vector2 position, string flag)
        {
            //Nested for loops to increase area size for touch press
            for (int xx = -5; xx <= 5; xx++)
            {
                for (int yy = -5; yy <= 5; yy++)
                {
                    ...
                    {
                        if (hits[i].transform.gameObject.tag == "PlanetMesh")
                        {
