...
namespace NewLean.Touch
{
	...
	public class NewLeanSnapshot
	{
		...
		public static List<NewLeanSnapshot> InactiveSnapshots = new List<NewLeanSnapshot>(1000);

		// Return the last inactive snapshot, or allocate a new one
		public static NewLeanSnapshot Pop()
		{
			...
			return new NewLeanSnapshot();
		}

		// This will return the recorded position of the current finger when it was at 'targetAge'
		public static bool TryGetScreenPosition(List<NewLeanSnapshot> snapshots, float targetAge, ref Vector2 screenPosition)
		{
		...
		public static bool TryGetSnapshot(List<NewLeanSnapshot> snapshots, int index, ref float age, ref Vector2 screenPosition)
		{
		...
		// NOTE: Assumes snapshots does not contain any null elements
		public static int GetLowerIndex(List<NewLeanSnapshot> snapshots, float targetAge)
		{
			if (snapshots != null)
			{
